...
##Clock signal
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports sysclk_0]
create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports sysclk_0]

##Desynchronize clocks between project IP and AXI wrapper/Processor System
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks sys_clk_pin] -group [get_clocks -include_generated_clocks clk_fpga_0]
